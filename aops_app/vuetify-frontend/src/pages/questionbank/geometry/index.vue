<template>
    <div class="d-flex justify-center">
        <div class="pt-10" style="width: 84%">
            ...
            <h2 class="text-center mb-4">Problems Geometry</h2>
...
export default {
    ...
    methods: {
        fetchData_original() {
            ...
            setTimeout(() => {
                axios
                    .get(`questionbank_original/Geometry`)
                    .then((response) => {
        ...
        fetchData_forspecific_contest_name() {
            ...
            axios
                .get(
                    `questionbank_specific_contestname/Geometry?contest_name=${this.selected_contest_name}`
                )
                .then((response) => {
